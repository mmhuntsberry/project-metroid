...
) VALUES ("Final Fantasy VII Remake", "Playstation 4",
2020, "https://images.igdb.com/igdb/image/upload/t_cover_big/co1qxr.jpg", "A spectacular re-imagining of one of the most visionary games ever,  Final Fantasy VII Remake rebuilds and expands the legendary RPG for today.  The first game in this project will be set in the eclectic city of Midgar and presents a fully standalone gaming experience.", "Description: The world has fallen under the control of the Shinra Electric Power Company, a shadowy corporation controlling the planet’s very life force as mako energy. In the sprawling city of Midgar, an anti-Shinra organization calling themselves  Avalanche have stepped up their resistance. Cloud Strife, a former member of Shinra’s elite SOLDIER unit now turned mercenary, lends his aid to the group, unaware of the epic consequences that await him.", "https://www.youtube.com/embed/QLYyWAqTTAo", 
"https://res.cloudinary.com/mattthebunny/image/upload/v1592439122/3652347-3532489-final_fantasy_7_remake_fkskvz.jpg", "Square Enix"), 
...
("Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat, debitis atque tenetur quos necessitatibus quod libero eveniet ipsum quaerat voluptates magni illo", 1),
("HODOR ipsum dolor sit amet consectetur, adipisicing elit. Repellat, debitis atque tenetur quos necessitatibus quod libero eveniet ipsum quaerat voluptates magni illo", 3);

/* INSERT INTO users (name, email) VALUES ('Matt', 'matt@gmail.com'), ('Stephanie', 'stephanie@gmail.com'), ('Link', 'link@gmail.com'); */

INSERT INTO themes (type) VALUES ('Horror'), ('Action'), ('kids'), ('Fantasy'), ('Survival');
 
INSERT INTO game_theme (game_id, theme_id) VALUES (1, 2), (1, 4);


INSERT INTO platforms (type, game_id) VALUES ('Atari'), ('Nintendo (NES)'), ('Super Nintendo (SNES)'), ('Sega Genesis'), ('Nintendo 64'), ('Playstation'), ('Gamecube'), ('Xbox'), ('Playstation 2'), ('Nintendo Wii'), ('Playstation 3'), ('Xbox 360'), ('Nintendo WiiU'), ('Playstation 4'), ('Xbox One'), ('Nintendo Switch');

INSERT INTO game_platform (game_id, theme_id) VALUES (1, 14);

INSERT INTO genres (type) VALUES ('Role Playing (RPG)'), (); 

INSERT INTO ratings (rating) VALUES (0), (1), (2), (3), (4), (5);

INSERT INTO game_rating (game_id, rating_id) VALUES (1, 6);
