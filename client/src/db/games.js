...
export const games = [
  {
    ...
    release_year: 2020,
    box_art: "https://images.igdb.com/igdb/image/upload/t_cover_big/co1qxr.jpg",
    synopsis: `A spectacular re-imagining of one of the most visionary games ever,  Final Fantasy VII Remake rebuilds and expands the legendary RPG for today.  The first game in this project will be set in the eclectic city of Midgar and presents a fully standalone gaming experience.`,
    description: `Description: The world has fallen under the control of the Shinra Electric Power Company, 
...
In the sprawling city of Midgar, an anti-Shinra organization calling themselves  Avalanche have stepped up their resistance. Cloud Strife, a former member of Shinra’s elite SOLDIER unit now turned mercenary, lends his aid to the group, unaware of the epic consequences that await him.   `,
    trailer: "https://www.youtube.com/embed/QLYyWAqTTAo",
    hero:
  ...
  },
  {
    ...
    box_art: "https://images.igdb.com/igdb/image/upload/t_cover_big/co2362.jpg",
