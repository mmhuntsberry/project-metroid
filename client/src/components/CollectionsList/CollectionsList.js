    ...
    <ContentWrapper currentlyPlaying={true}>
      <CollectionListContainer>
        {props.collectionListData.map(collection => {
          return (
            <CollectionItem key={collection.title}>
              <CollectionContainer>
                <CollectionThumbnail src={collection.thumbnail} />
                <CollectionInfoContainer>
                  <CollectionMetaAndTitle>
                    <CollectionTitle className="text-truncate--three-lines">{collection.title}</CollectionTitle>
                    <CollectionMetaInfo>
                      <CollectionGames>
                      ...
                      <CollectionComments isMain={collection.isMain}>
                        ...
                        {collection.comments}
                        <CollectionCommentsText>{`${collection.comments === "1" ? " Comment" : " Comments"}`}</CollectionCommentsText>
                      </CollectionComments>
                    </CollectionMetaInfo>
                  </CollectionMetaAndTitle>
              ...
              ? <CollectionControlsDropdownList>
                  ...
                  <CollectionControlsDropdownListItem className="delete">
                    Delete collection
                  </CollectionControlsDropdownListItem>
                </CollectionControlsDropdownList>
              : null }
